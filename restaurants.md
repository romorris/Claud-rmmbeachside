---
layout: default
title: Local Dining & Guidebook
---

<div style="text-align: center; background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=1200&q=80') no-repeat center center; background-size: cover; padding: 80px 20px; color: white; border-radius: 20px; margin-bottom: 40px;">
  <h1 style="font-size: 3rem; color: white; text-shadow: 2px 2px 8px rgba(0,0,0,0.5);">Local Dining & Guide</h1>
  <p style="font-size: 1.2rem; opacity: 0.9;">Michelle's Top Recommendations in Jupiter</p>
</div>

<div class="content-card">
  <h2>🌟 Michelle's Favorites</h2>
  <p>Explore the best of Jupiter's food scene with these locally-loved spots, straight from our official guest guidebook.</p>
...
<div class="content-card" style="text-align: center;">
  <h3>Want the full Guidebook?</h3>
  <p>Browse all 25+ local recommendations on our official Airbnb Guidebook.</p>
  <a href="https://www.airbnb.com/s/guidebooks?refinement_paths%5B%5D=/guidebooks/3001699" target="_blank" style="display: inline-block; background-color: #ff385c; color: white; padding: 12px 30px; text-decoration: none; border-radius: 50px; font-weight: bold;">View Full Airbnb Guidebook</a>
</div>
